...
<head>
  ...
  <title>Viagem10 - Editar Viagem</title>
</head>
  ...
  <main>
    ...
    <section class="container-form">
      <form method="POST" action="../controladora/processar-editar-viagem.php" id="editarForm" enctype="multipart/form-data">
        ...
        <input type="text" id="descricao" name="descricao" value="<?= $viagem->getDescricao(); ?>" required>
        ...
        ?>
        <label for="imagem">Envie uma nova imagem da viagem ou mantenha a imagem atual:
        ...
        <input type="submit" name="editar" class="botao-cadastrar" value="Editar viagem" />
      </form>
